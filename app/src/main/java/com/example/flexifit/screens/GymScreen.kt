    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        HorizontalPager(
            ...
            BoxWithConstraints(modifier = Modifier.fillMaxSize().padding(24.dp)) {
                ...
                with(density) {
                    @Composable
                    fun overlayBox(x: Float, y: Float, w: Float, h: Float, color: Color, onClick: () -> Unit) {
                        Box(
                            modifier = Modifier
                                .absoluteOffset(
                                    x = (x * imageWidth).toDp(),
                    ...
                    if(page==0){
                        overlayBox(0.393f, 0.20f, 0.21f, 0.09f, Color.Transparent) {
                            // Handle chest click
                            imageRes = R.drawable.chest
                        }
                        overlayBox(0.425f, 0.29f, 0.15f, 0.2f, Color.Transparent) {
                            // Handle abs click
                            imageRes = R.drawable.abs
                        }
                        overlayBox(0.30f, 0.184f, 0.1f, 0.08f, Color.Transparent) {
                            // Left shoulder
                            imageRes = R.drawable.left_shoulder
                        }
                        overlayBox(0.6f, 0.184f, 0.1f, 0.08f, Color.Transparent) {
                            // Right shoulder
                            imageRes = R.drawable.right_shoulder
                        }
                        overlayBox(0.35f, 0.49f, 0.12f, 0.22f, Color.Transparent) {
                            // Left leg
                            imageRes = R.drawable.left_quad
                        }
                        overlayBox(0.53f, 0.49f, 0.12f, 0.22f, Color.Transparent) {
                            // Right leg
                            imageRes = R.drawable.right_quad
                        }
                        overlayBox(0.38f, 0.15f, 0.08f, 0.05f, Color.Transparent) {
                            // Left Trap
                            imageRes = R.drawable.traps
                        }
                        overlayBox(0.54f, 0.15f, 0.08f, 0.05f, Color.Transparent) {
                            // Right Trap
                            imageRes = R.drawable.traps
                        }
                        overlayBox(0.26f, 0.26f, 0.11f, 0.1f, Color.Transparent) {
                            // Left Bicep
                            imageRes = R.drawable.left_bicep
                        }
                        overlayBox(0.63f, 0.26f, 0.11f, 0.1f, Color.Transparent) {
                            // Right Bicep
                            imageRes = R.drawable.right_bicep
                        }
                        overlayBox(0.17f, 0.32f, 0.12f, 0.13f, Color.Transparent) {
                            // Left forearm
                            imageRes = R.drawable.forearm_left
                        }
                        overlayBox(0.71f, 0.32f, 0.12f, 0.13f, Color.Transparent) {
                            // Right forearm
                        ...
                        overlayBox(0.30f, 0.184f, 0.13f, 0.07f, Color.Transparent) {
                            // Left shoulder
                            imageRes = R.drawable.left_shoulder_back
                        }
                        overlayBox(0.57f, 0.184f, 0.13f, 0.07f, Color.Transparent) {
                            // Right shoulder
                            imageRes = R.drawable.right_shoulder_back
                        }
                        overlayBox(0.26f, 0.25f, 0.11f, 0.1f, Color.Transparent) {
                            // Left Tricep
                            imageRes = R.drawable.tricep_left
                        }
                        overlayBox(0.63f, 0.25f, 0.11f, 0.1f, Color.Transparent) {
                            // Right Tricep
                            imageRes = R.drawable.tricep_right
                        }
                        overlayBox(0.17f, 0.33f, 0.12f, 0.13f, Color.Transparent) {
                            // Left forearm
                            imageRes = R.drawable.forearm_left_back
                        }
                        overlayBox(0.71f, 0.33f, 0.12f, 0.13f, Color.Transparent) {
                            // Right forearm
                            imageRes = R.drawable.forearm_right_back
                        }
                        overlayBox(0.44f, 0.21f, 0.12f, 0.11f, Color.Transparent) {
                            // Mid back
                            imageRes = R.drawable.traps_mid_back
                        }
                        overlayBox(0.36f, 0.25f, 0.12f, 0.19f, Color.Transparent) {
                            // Left back
                            imageRes = R.drawable.left_lat
                        }
                        overlayBox(0.52f, 0.25f, 0.12f, 0.19f, Color.Transparent) {
                            // Right back
                            imageRes = R.drawable.right_lat
                        }
                        overlayBox(0.4f, 0.43f, 0.2f, 0.11f, Color.Transparent) {
                            // Glutes
                            imageRes = R.drawable.hips
                        }
                        overlayBox(0.46f, 0.31f, 0.08f, 0.12f, Color.Transparent) {
                            // Mid lower back
                            imageRes = R.drawable.lower_back
                        }
                        overlayBox(0.35f, 0.53f, 0.12f, 0.18f, Color.Transparent) {
                            // Left leg
                            imageRes = R.drawable.left_glute
                        }
                        overlayBox(0.53f, 0.53f, 0.12f, 0.18f, Color.Transparent) {
                            // Right leg
                            imageRes = R.drawable.right_glute
                        }
                        overlayBox(0.34f, 0.74f, 0.1f, 0.11f, Color.Transparent) {
                            // Left leg
                            imageRes = R.drawable.left_calve_back
                        }
                        overlayBox(0.56f, 0.74f, 0.1f, 0.11f, Color.Transparent) {
                            // Right leg
